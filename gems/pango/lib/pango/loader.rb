...
module Pango
  class Loader < GObjectIntrospection::Loader
    ...
    def require_extension
      ...
      # For Windows binary gems, bundled DLLs are in lib/pango/vendor/bin/. We must add this
      # to the DLL search path BEFORE loading pango.so, otherwise Windows won't find the
      ...
      # .so files in version-specific directories: lib/pango/3.3/pango.so, lib/pango/3.4/pango.so
