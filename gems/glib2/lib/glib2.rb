...
# We must add this to the DLL search path BEFORE loading glib2.so, otherwise Windows won't
# find the required GTK3 DLLs (libglib-2.0-0.dll, etc.) and loading will fail with LoadError 126.
# This matches the official ruby-gnome binary gem strategy: vendor/local/bin at gem root.
