...
- Changes to `glib2.gemspec` (we modify this for platform/files/extensions)
- New dependencies or requirements
- API changes that affect our build process

**Critical: Our gemspec modifications include:**
- `s.platform = Gem::Platform.new('x64-mingw32')` - Set platform
- `s.extensions` - REMOVED/COMMENTED OUT (prevents compilation at install)
- `s.files += Dir.glob("lib/**/*.so")` - Include precompiled extensions
- `s.files += Dir.glob("lib/**/vendor/**/*")` - Include vendor DLLs
- Runtime dependencies - REMOVED (pkg-config, native-package-installer)
