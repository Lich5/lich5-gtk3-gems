...
Gem::Specification.new do |s|
  ...
  # because all libraries are bundled in lib/gobject-introspection/vendor/. These requirements
  # are only needed for source gems that compile against system-installed GObject Introspection.
  #
